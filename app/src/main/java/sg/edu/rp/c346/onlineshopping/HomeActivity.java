...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_settings, R.id.nav_cart,R.id.nav_settings)
        ...
        TextView usernameTV = headerView.findViewById(R.id.textView);
        ImageView profileIM = headerView.findViewById(R.id.imageView);
